...
def create_parser():
    ...
    parser = argparse.ArgumentParser(prog = "ebbreak")
    ...
    classify.add_argument("tumor_bp_contig_file", metavar = "tumor_bp_contig.txt", type = str,
                     help = "path to tumor contig file generated by contig function")

    classify.add_argument("output_canonical_file", metavar = "canonical_SV.txt", type = str,
                     help = "path to output file (canonical_SV)")

    classify.add_argument("output_non_canonical_file", metavar = "non_canonical_SV.txt", type = str,
                     help = "path to output file (non_canonical_SV)")

    classify.add_argument("--grc", default = False, action = 'store_true',
    ...
    classify.add_argument("--genome_id", choices = ["hg19", "hg38", "mm10"], default = "hg19",
