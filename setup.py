...
def get_version():
    with open(path.join(here, "ebbreak/version.py"), encoding = 'utf-8') as hin:
        for line in hin:
...
setup(
    ...
    url = 'https://github.com/nccmo/EBbreak_modified',
    ...
    install_requires = [],
    entry_points = {'console_scripts': ['ebbreak = ebbreak:main']}
